...
public:
   ...
   void addAdjacency(ConstraintGraphNode* Src, TypeVariableType* T);

   /// Remove an adjacency of a node.
   void removeAdjacency(ConstraintGraphNode* Src, TypeVariableType* T);
   ...
   void bindVariadicTypeVariable(TypeVariableType* TypeVar, QualType ConcreteTy,
                                 unsigned Index);
   ...
   ArrayRef<Constraint*> getActiveConstraints() const
   {
