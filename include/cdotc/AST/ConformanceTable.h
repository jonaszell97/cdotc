...
class ConformanceTable {
   ...
   using SingleOrSet = llvm::PointerUnion<ast::ProtocolDecl*, ConformanceSet*>;
   ...
   bool registerConformance(ast::ASTContext& C, ast::RecordDecl* Rec,
                            ast::ProtocolDecl* P);
...
public:
   ...
   bool addInheritedConformance(ast::ASTContext& C, ast::RecordDecl* Decl,
                                ast::ProtocolDecl* P);

   bool addImplicitConformance(ast::ASTContext& C, ast::RecordDecl* Decl,
                               ast::ProtocolDecl* P);

   llvm::ArrayRef<Conformance*> getAllConformances(ast::RecordDecl* Decl) const;

   template<ConformanceKind Kind> struct iterator {
   ...
   public:
      iterator(pointer Ptr, pointer End) : Ptr(Ptr), End(End) { moveToNext(); }
