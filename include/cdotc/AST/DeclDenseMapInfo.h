...
template<> struct PointerLikeTypeTraits<::cdot::ast::Decl*> {
public:
...
template<> struct PointerLikeTypeTraits<::cdot::ast::RecordDecl*> {
public:
   static inline void* getAsVoidPointer(::cdot::ast::RecordDecl* P)
   {
      return P;
   }
...
template<> struct PointerLikeTypeTraits<::cdot::ast::ProtocolDecl*> {
public:
