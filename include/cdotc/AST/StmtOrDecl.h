...
struct StmtOrDecl {
   ...
   ast::Statement* getStatement() const { return Union.get<ast::Statement*>(); }
   ...
   void* getAsOpaquePtr() const { return Union.getOpaqueValue(); }
...
template<> struct PointerLikeTypeTraits<::cdot::StmtOrDecl> {
public:
