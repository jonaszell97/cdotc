...
public:
   ...
   static DeclConstraint* Create(ASTContext& C, Kind K,
                                 QualType ConstrainedType, QualType RHS);

   static DeclConstraint* Create(ASTContext& C, QualType ConstrainedType,
                                 AliasDecl* Concept);

   static void Profile(llvm::FoldingSetNodeID& ID, Kind K,
                       QualType ConstrainedType, QualType RHS);

   static void Profile(llvm::FoldingSetNodeID& ID, QualType ConstrainedType,
                       AliasDecl* Concept);
...
private:
   DeclConstraint(Kind K, QualType ConstrainedType, QualType RHS);

   DeclConstraint(QualType ConstrainedType, AliasDecl* Concept);
...
public:
   ...
   static ConstraintSet* Combine(ASTContext& C, ConstraintSet* C1,
                                 ConstraintSet* C2);
   ...
   iterator begin() const { return getTrailingObjects<DeclConstraint*>(); }
...
public:
   ...
   ParsedConstraint(Kind k, SourceRange SR,
...
public:
   ...
   Create(ASTContext& C, DeclarationName Name, SourceType covariance,
   ...
   static TemplateParamDecl* Create(ASTContext& C, DeclarationName Name,
...
private:
   TemplateParamDecl(DeclarationName Name, SourceType covariance,
                     SourceType contravariance, Expression* defaultValue,
                     unsigned Index, SourceLocation TypeNameOrValueLoc,
                     SourceLocation NameLoc, SourceLocation EllipsisLoc,
                     bool Unbounded);

   TemplateParamDecl(DeclarationName Name, SourceType valueType,
                     Expression* defaultValue, unsigned Index,
                     SourceLocation TypeNameOrValueLoc, SourceLocation NameLoc,
                     SourceLocation EllipsisLoc, bool Unbounded);
...
protected:
   VarDecl(DeclKind id, AccessSpecifier access, SourceLocation VarOrLetLoc,
           SourceLocation ColonLoc, bool isConst, DeclarationName Name,
...
class LocalVarDecl : public VarDecl {
   LocalVarDecl(AccessSpecifier access, SourceLocation VarOrLetLoc,
                SourceLocation ColonLoc, bool isConst, DeclarationName Name,
                SourceType type, Expression* value);
...
public:
   static LocalVarDecl* Create(ASTContext& C, AccessSpecifier access,
                               SourceLocation VarOrLetLoc,
...
class GlobalVarDecl : public VarDecl {
   GlobalVarDecl(AccessSpecifier access, SourceLocation VarOrLetLoc,
                 SourceLocation ColonLoc, bool isConst, DeclarationName Name,
                 SourceType type, Expression* value);
...
public:
   static GlobalVarDecl* Create(ASTContext& C, AccessSpecifier access,
                                SourceLocation VarOrLetLoc,
                                SourceLocation ColonLoc, bool isConst,
                                DeclarationName Name, SourceType type,
                                Expression* value);
...
class DestructuringDecl final : public Decl,
                                TrailingObjects<DestructuringDecl, VarDecl*> {
public:
...
private:
   DestructuringDecl(SourceRange Parens, ArrayRef<VarDecl*> Decls,
                     SourceType Type, Expression* value);
...
public:
   static bool classofKind(DeclKind kind)
   {
      return kind == DestructuringDeclID;
   }
   static bool classof(Decl const* T) { return classofKind(T->getKind()); }

   friend TrailingObjects;

   static DestructuringDecl* Create(ASTContext& C, SourceRange Parens,
...
class FuncArgDecl : public VarDecl {
   FuncArgDecl(SourceLocation OwnershipLoc, SourceLocation ColonLoc,
               DeclarationName Name, IdentifierInfo* Label,
               ArgumentConvention Conv, SourceType argType,
               Expression* defaultValue, bool variadicArgPackExpansion,
...
public:
   static FuncArgDecl* Create(ASTContext& C, SourceLocation OwnershipLoc,
                              ...
                              bool cstyleVararg = false, bool isSelf = false);
...
class ModuleDecl final : public NamedDecl, public DeclContext {
   ModuleDecl(SourceRange Loc, DeclarationName moduleName);
...
public:
   ...
   static ModuleDecl* Create(ASTContext& C, SourceRange Loc,
...
class SourceFileDecl final : public NamedDecl, public DeclContext {
   SourceFileDecl(SourceRange FileRange, DeclarationName FileName);
...
public:
   ...
   static SourceFileDecl* Create(ASTContext& C, SourceRange FileRange,
...
class ImportDecl final : public NamedDecl,
   ...
   ImportDecl(SourceRange Loc, AccessSpecifier Access,
...
public:
   ...
   static ImportDecl* Create(ASTContext& C, SourceRange Loc,
...
class NamespaceDecl : public NamedDecl, public DeclContext {
   NamespaceDecl(SourceLocation NamespaceLoc, SourceLocation LBrace,
...
public:
   static NamespaceDecl* Create(ASTContext& C, SourceLocation NamespaceLoc,
                                SourceLocation LBrace, DeclarationName Name);
...
public:
   ...
   CompoundDecl(SourceLocation LBraceLoc, bool Transparent);

   static CompoundDecl* Create(ASTContext& C, SourceLocation LBraceLoc,
                               bool Transparent);
...
class CallableDecl : public NamedDecl,
                     public DeclContext,
                     public llvm::FoldingSetNode {
public:
   static bool classof(Decl const* T) { return classofKind(T->getKind()); }
...
protected:
   CallableDecl(DeclKind typeID, AccessSpecifier am, SourceLocation DefLoc,
                DeclarationName Name, SourceType returnType,
                ArrayRef<FuncArgDecl*> args, Statement* body,
...
public:
   ...
   ASTVector<TemplateParamDecl*>& getTemplateParams() { return templateParams; }
...
class FunctionDecl : public CallableDecl {
   FunctionDecl(AccessSpecifier am, SourceLocation DefLoc, DeclarationName II,
                llvm::ArrayRef<FuncArgDecl*> args, SourceType returnType,
                Statement* body,
                ASTVector<TemplateParamDecl*>&& templateParams);
...
public:
   static FunctionDecl* Create(ASTContext& C, AccessSpecifier am,
                               SourceLocation DefLoc, DeclarationName II,
...
class TypedefDecl : public NamedDecl {
   TypedefDecl(AccessSpecifier access, SourceLocation Loc, DeclarationName Name,
               SourceType origin,
               ASTVector<TemplateParamDecl*>&& templateParams);
...
public:
   static TypedefDecl* Create(ASTContext& C, AccessSpecifier access,
...
class AliasDecl final : public NamedDecl,
   ...
   AliasDecl(SourceLocation Loc, AccessSpecifier AccessSpec,
             DeclarationName Name, SourceType Type, StaticExpr* aliasExpr,
...
public:
   static AliasDecl* Create(ASTContext& C, SourceLocation Loc,
...
public:
   ...
   [[nodiscard]] DeclContext::AddDeclResultKind addDecl(NamedDecl* decl);

   template<class FnTy>
   typename std::enable_if<
       std::is_same_v<decltype((*(FnTy*)(0))(QualType())), bool>, void>::type
   visitStoredTypes(const FnTy& F);

protected:
   RecordDecl(DeclKind typeID, AccessSpecifier access,
...
public:
   static FieldDecl* Create(ASTContext& C, AccessSpecifier Access,
...
private:
   FieldDecl(AccessSpecifier Access, SourceLocation VarOrLetLoc,
             SourceLocation ColonLoc, DeclarationName Name, SourceType Type,
             bool IsStatic, bool IsConst, Expression* DefaultVal);
...
public:
   static StructDecl* Create(ASTContext& C, AccessSpecifier access,
                             SourceLocation KeywordLoc, DeclarationName Name,
                             ASTVector<SourceType>&& conformanceTypes,
                             ASTVector<TemplateParamDecl*>&& templateParams);
   ...
   void setParameterlessConstructor(InitDecl* C)
   {
      parameterlessConstructor = C;
   }

   InitDecl* getMemberwiseInitializer() const { return memberwiseInitializer; }
   void setMemberwiseInitializer(InitDecl* Init)
   {
      memberwiseInitializer = Init;
   }
...
private:
   StructDecl(AccessSpecifier access, SourceLocation KeywordLoc,
              DeclarationName Name, ASTVector<SourceType>&& conformanceTypes,
              ASTVector<TemplateParamDecl*>&& templateParams);

protected:
   StructDecl(DeclKind typeID, AccessSpecifier access,
              SourceLocation KeywordLoc, DeclarationName Name,
              ASTVector<SourceType>&& conformanceTypes,
              ASTVector<TemplateParamDecl*>&& templateParams);
...
public:
   static ClassDecl* Create(ASTContext& C, AccessSpecifier access,
                            SourceLocation KeywordLoc, DeclarationName Name,
                            ASTVector<SourceType>&& conformanceTypes,
                            ASTVector<TemplateParamDecl*>&& templateParams,
...
private:
   ClassDecl(AccessSpecifier access, SourceLocation KeywordLoc,
             DeclarationName Name, ASTVector<SourceType>&& conformanceTypes,
             ASTVector<TemplateParamDecl*>&& templateParams,
             SourceType parentClass, bool isAbstract);
...
public:
   static EnumDecl* Create(ASTContext& C, AccessSpecifier access,
                           SourceLocation KeywordLoc, DeclarationName Name,
                           ASTVector<SourceType>&& conformanceTypes,
                           ASTVector<TemplateParamDecl*>&& templateParams,
                           SourceType rawType);
...
private:
   EnumDecl(AccessSpecifier access, SourceLocation KeywordLoc,
            DeclarationName Name, ASTVector<SourceType>&& conformanceTypes,
            ASTVector<TemplateParamDecl*>&& templateParams, SourceType rawType);
...
public:
   static UnionDecl* Create(ASTContext& C, AccessSpecifier access,
                            SourceLocation KeywordLoc, DeclarationName Name,
                            ASTVector<SourceType>&& conformanceTypes,
                            ASTVector<TemplateParamDecl*>&& templateParams);
   ...
   static bool classof(Decl const* T) { return classofKind(T->getKind()); }
   static bool classofKind(DeclKind kind) { return kind == UnionDeclID; }
...
private:
   UnionDecl(AccessSpecifier access, SourceLocation KeywordLoc,
             DeclarationName Name, ASTVector<SourceType>&& conformanceTypes,
             ASTVector<TemplateParamDecl*>&& templateParams);
...
public:
   static ProtocolDecl* Create(ASTContext& C, AccessSpecifier access,
                               SourceLocation KeywordLoc, DeclarationName Name,
                               ASTVector<SourceType>&& conformanceTypes,
                               ASTVector<TemplateParamDecl*>&& templateParams);
   ...
   bool hasAssociatedTypeConstraint() const
   {
      return HasAssociatedTypeConstraint;
   }
   void setHasAssociatedTypeConstraint(bool V)
   {
      HasAssociatedTypeConstraint = V;
   }
...
public:
   static ExtensionDecl* Create(ASTContext& C, AccessSpecifier access,
                                SourceLocation KeywordLoc,
...
private:
   ExtensionDecl(AccessSpecifier access, SourceLocation KeywordLoc,
                 SourceType ExtendedType,
                 llvm::ArrayRef<SourceType> conformanceTypes);

   ExtensionDecl(AccessSpecifier access, SourceLocation KeywordLoc,
                 RecordDecl* R, llvm::ArrayRef<SourceType> conformanceTypes);
...
class MethodDecl : public CallableDecl,
                   public DefaultImplementable<MethodDecl> {
public:
   static MethodDecl* Create(ASTContext& C, AccessSpecifier access,
                             SourceLocation DefLoc, DeclarationName II,
                             SourceType returnType,
                             llvm::ArrayRef<FuncArgDecl*> args,
                             ASTVector<TemplateParamDecl*>&& templateParams,
   ...
   static MethodDecl*
   CreateOperator(ASTContext& C, AccessSpecifier access, SourceLocation DefLoc,
                  DeclarationName OperatorName, SourceType returnType,
                  llvm::ArrayRef<FuncArgDecl*> args,
                  ASTVector<TemplateParamDecl*>&& templateParams,
                  Statement* body, bool isStatic);

   static MethodDecl* CreateConversionOp(
...
private:
   MethodDecl(AccessSpecifier access, SourceLocation DefLoc, DeclarationName II,
              SourceType returnType, llvm::ArrayRef<FuncArgDecl*> args,
              ASTVector<TemplateParamDecl*>&& templateParams, Statement* body,
              bool isStatic);
   ...
   MethodDecl(AccessSpecifier access, SourceLocation DefLoc,
              SourceType returnType, llvm::ArrayRef<FuncArgDecl*> args,
              ASTVector<TemplateParamDecl*>&& templateParams, Statement* body);

protected:
   MethodDecl(DeclKind typeID, AccessSpecifier access, SourceLocation Loc,
              DeclarationName Name, SourceType returnType,
              llvm::ArrayRef<FuncArgDecl*> args,
              ASTVector<TemplateParamDecl*>&& templateParams, Statement* body);
...
public:
   ...
   SourceLocation getBodyInstantiationLoc() const
   {
...
public:
   static InitDecl* CreateMemberwise(ASTContext& C, AccessSpecifier am,
                                     SourceLocation Loc,
                                     DeclarationName Name = DeclarationName());

   static InitDecl*
   Create(ASTContext& C, AccessSpecifier am, SourceLocation Loc,
          llvm::ArrayRef<FuncArgDecl*> args,
          ASTVector<TemplateParamDecl*>&& templateParams, Statement* body,
          DeclarationName Name = DeclarationName(), bool IsFallible = false);
...
private:
   InitDecl(AccessSpecifier am, SourceLocation Loc, DeclarationName Name);

   InitDecl(AccessSpecifier am, SourceLocation Loc,
            llvm::ArrayRef<FuncArgDecl*> args,
            ASTVector<TemplateParamDecl*>&& templateParams, Statement* body,
            DeclarationName Name, bool IsFallible);
...
public:
   ...
   bool isCompleteInitializer() const
   {
      return Kind == ConstructorKind::Complete;
   }
...
class DeinitDecl : public MethodDecl {
   explicit DeinitDecl(SourceLocation Loc, Statement* body,
                       llvm::ArrayRef<FuncArgDecl*> args, DeclarationName Name);

   DeinitDecl(EmptyShell Empty, unsigned N);

public:
   static DeinitDecl* Create(ASTContext& C, SourceLocation Loc, Statement* body,
                             llvm::ArrayRef<FuncArgDecl*> args,
                             DeclarationName Name = DeclarationName());
...
public:
   static AssociatedTypeDecl* Create(ASTContext& C, SourceLocation Loc,
                                     DeclarationName Name,
...
private:
   AssociatedTypeDecl(SourceLocation Loc, DeclarationName Name,
                      SourceType defaultValue, SourceType covariance);
...
class PropDecl : public NamedDecl, public DefaultImplementable<PropDecl> {
   PropDecl(AccessSpecifier access, SourceRange Loc, DeclarationName Name,
...
public:
   static PropDecl* Create(ASTContext& C, AccessSpecifier access,
                           SourceRange Loc, DeclarationName Name,
                           SourceType type, bool isStatic, bool IsReadWrite,
                           MethodDecl* GetterMethod, MethodDecl* SetterMethod);
...
class EnumCaseDecl : public CallableDecl {
   EnumCaseDecl(AccessSpecifier AS, SourceLocation CaseLoc,
                SourceLocation IdentLoc, DeclarationName Name,
                StaticExpr* rawValue, llvm::ArrayRef<FuncArgDecl*> args);
...
public:
   static EnumCaseDecl* Create(ASTContext& C, AccessSpecifier AS,
                               SourceLocation CaseLoc, SourceLocation IdentLoc,
...
class StaticIfDecl : public Decl {
   StaticIfDecl(SourceLocation StaticLoc, SourceLocation RBRaceLoc,
...
public:
   static StaticIfDecl* Create(ASTContext& C, SourceLocation StaticLoc,
                               SourceLocation RBRaceLoc, StaticExpr* condition,
                               CompoundDecl* IfDecl, CompoundDecl* ElseDecl);
...
class StaticForDecl : public Decl {
   StaticForDecl(SourceLocation StaticLoc, SourceLocation RBRaceLoc,
...
public:
   static StaticForDecl* Create(ASTContext& C, SourceLocation StaticLoc,
                                SourceLocation RBRaceLoc,
                                IdentifierInfo* elementName, StaticExpr* range,
                                CompoundDecl* BodyDecl);
...
class StaticAssertDecl : public Decl {
   StaticAssertDecl(SourceLocation Loc, SourceRange Parens, StaticExpr* expr,
                    StringRef message);
...
public:
   static StaticAssertDecl* Create(ASTContext& C, SourceLocation Loc,
...
class StaticPrintDecl : public Decl {
   StaticPrintDecl(SourceLocation Loc, SourceRange Parens, Expression* expr);
...
public:
   static StaticPrintDecl* Create(ASTContext& C, SourceLocation Loc,
...
public:
   static MixinDecl* Create(ASTContext& C, SourceLocation Loc,
...
private:
   MixinDecl(SourceLocation Loc, SourceRange Parens, Expression* MixinExpr);
...
class PrecedenceGroupDecl : public NamedDecl {
   PrecedenceGroupDecl(SourceRange SR, AccessSpecifier AS, DeclarationName DN,
                       Associativity Assoc,
...
public:
   ...
   Create(ASTContext& C, SourceRange SR, AccessSpecifier AS, DeclarationName DN,
   ...
   static bool classofKind(DeclKind kind)
   {
      return kind == PrecedenceGroupDeclID;
   }
   static bool classof(Decl const* T) { return classofKind(T->getKind()); }
...
class OperatorDecl : public NamedDecl {
   OperatorDecl(SourceRange SR, AccessSpecifier AS, DeclarationName Name,
...
public:
   static OperatorDecl* Create(ASTContext& C, SourceRange SR,
                               AccessSpecifier AS, DeclarationName OperatorName,
                               const IdentifierInfo* PGIdent);
...
struct StateTransition {
   StateTransition(const lex::Token& Tok, PatternFragment* Next,
                   bool IsConsuming = true, bool NeedsBackpatching = false)
       : Tok(Tok), Next(Next), IsConsuming(IsConsuming),
         NeedsBackpatching(NeedsBackpatching)
   {
   }
   ...
   bool isEOF() const { return Tok.getKind() == lex::tok::eof; }
...
private:
   ...
   PatternFragment(SourceLocation Loc, VariableKind VarKind,
                   const IdentifierInfo* VarName);

   PatternFragment(SourceLocation Loc, FragmentKind RepetitionKind,
                   PatternFragment* BeginState, PatternFragment* EndState,
...
public:
   ...
   static PatternFragment* Create(ASTContext& C, SourceLocation Loc,
   ...
   static PatternFragment* GetErrorState() { return &ErrorState; }
   ...
   bool isEndState() const { return !Transitions[0] && !Transitions[1]; }
   ...
   {
      assert(isToken());
      return {reinterpret_cast<lex::Token const*>(this + 1), TokData.NumTokens};
   }
                      ...
                      bool IsConsuming = true, bool NeedsBackpatching = false)
   {
      if (!Transitions[0]) {
         Transitions[0]
             = StateTransition(Tok, Next, IsConsuming, NeedsBackpatching);
      }
      else {
...
private:
   ExpansionFragment(SourceLocation Loc, const IdentifierInfo* VarName);
...
public:
   static ExpansionFragment* Create(ASTContext& C, SourceLocation Loc,
...
class MacroPattern final
    : llvm::TrailingObjects<MacroPattern, ExpansionFragment*> {
   MacroPattern(SourceLocation Loc, PatternFragment* Pattern,
...
public:
   static MacroPattern* Create(ASTContext& C, SourceLocation Loc,
                               PatternFragment* Pattern,
                               SourceLocation ExpansionLoc,
                               llvm::ArrayRef<ExpansionFragment*> Expansion,
                               unsigned SourceLength);
   ...
   {
      return {getTrailingObjects<ExpansionFragment*>(), NumExpansionFragments};
   }
...
private:
   MacroDecl(SourceRange SR, AccessSpecifier AS, DeclarationName Name,
...
public:
   static MacroDecl* Create(ASTContext& C, SourceRange SR, AccessSpecifier AS,
...
private:
   MacroExpansionDecl(SourceRange SR, DeclarationName MacroName,
...
public:
   static MacroExpansionDecl* Create(ASTContext& C, SourceRange SR,
                                     DeclarationName MacroName,
                                     Expression* ParentExpr, Delimiter Delim,
                                     llvm::ArrayRef<lex::Token> Toks);
   ...
   static bool classofKind(DeclKind kind)
   {
      return kind == MacroExpansionDeclID;
   }
   static bool classof(Decl const* T) { return classofKind(T->getKind()); }
...
class UnittestDecl : public Decl, public DeclContext {
   UnittestDecl(SourceLocation KeywordLoc, SourceRange BraceRange,
...
public:
   ...
   static UnittestDecl* Create(ASTContext& C, SourceLocation KeywordLoc,
...
/// isa<T>(DeclContext*)
template<typename To> struct isa_impl<To, ::cdot::ast::DeclContext> {
...
/// cast<T>(DeclContext*)
template<class ToTy>
struct cast_convert_val<ToTy, const ::cdot::ast::DeclContext,
                        const ::cdot::ast::DeclContext> {
