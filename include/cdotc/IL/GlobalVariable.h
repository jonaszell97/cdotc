...
public:
   GlobalObject(TypeID id, QualType ty, Module* module, llvm::StringRef name);
...
class GlobalVariable
    : public GlobalObject,
      public llvm::ilist_node_with_parent<GlobalVariable, Module> {
public:
   GlobalVariable(QualType ty, bool isConstant, llvm::StringRef name,
                  Module* module, Constant* initializer = nullptr);
   ...
   serial::LazyILGlobalInfo* getLazyGlobalInfo() const
   {
      return LazyGlobalInfo;
   }
