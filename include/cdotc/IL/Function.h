...
public:
   ...
   Function(llvm::StringRef name, FunctionType* funcTy, Module* parent);
   ...
   ValueSymbolTable* getSymTab() const { return BasicBlocks.getSymTab().get(); }
...
public:
   Lambda(FunctionType* funcTy, Module* parent);

   llvm::ArrayRef<QualType> getCaptures() const { return captures; }

   void addCapture(QualType type) { captures.push_back(type); }
...
public:
   ...
   Method(llvm::StringRef name, FunctionType* FuncTy, bool isStatic,
...
public:
   ...
   Initializer(llvm::StringRef methodName, FunctionType* FuncTy,
