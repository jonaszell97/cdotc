...
public:
   ...
   InsertPointGuard MakeInsertPointGuard() { return InsertPointGuard(*this); }
   ...
   InsertPoint saveIP() { return {InsertBlock, insertPoint, LastDebugLoc}; }
   ...
   ConstantClass* GetConstantClass(ast::ClassDecl* S, GlobalVariable* TI,
                                   llvm::ArrayRef<Constant*> elements,
                                   ConstantClass* Base = nullptr);

   ConstantClass* GetConstantClass(ConstantStruct* S, GlobalVariable* TI,
                                   ConstantClass* Base = nullptr);
   ...
   Constant* GetConstantNull(QualType ty) { return GetConstantPtr(ty, 0); }
   ...
   Lambda* CreateLambda(QualType returnType, llvm::ArrayRef<Argument*> args,
                        bool mightThrow, SourceLocation loc = {});

   Method* CreateMethod(llvm::StringRef methodName, QualType returnType,
   ...
   GlobalVariable* CreateGlobalVariable(QualType type, bool isConst = false,
   ...
   CallInst* CreateCall(Value* Callee, llvm::ArrayRef<Value*> args,
                        llvm::StringRef name = "");
   ...
   VirtualCallInst* CreateVirtualCall(Value* VTableOwner, FunctionType* FnTy,
                                      il::GlobalVariable* ProtocolTypeInfo,
                                      unsigned Offset, ArrayRef<Value*> args,
                                      StringRef name = "");

   LambdaCallInst* CreateLambdaCall(Value* Func, llvm::ArrayRef<Value*> args,
                                    llvm::StringRef name = "");

   InvokeInst* CreateInvoke(Value* Callee, ArrayRef<Value*> args,
                            BasicBlock* NormalCont, BasicBlock* LandingPad,
                            llvm::StringRef name = "");

   VirtualInvokeInst*
   CreateVirtualInvoke(Value* VTableOwner, FunctionType* FnTy,
                       il::GlobalVariable* ProtocolTypeInfo, unsigned Offset,
                       ArrayRef<Value*> args, BasicBlock* NormalCont,
                       BasicBlock* LandingPad, StringRef name = "");

   AllocaInst* CreateAlloca(QualType ofType, unsigned align = 0,
                            bool heap = false, bool IsLet = false,
                            llvm::StringRef name = "");

   AllocaInst* CreateAlloca(QualType ofType, Value* allocSize,
                            unsigned align = 0, bool heap = false,
                            bool IsLet = false, llvm::StringRef name = "");

   AllocaInst* CreateAlloca(QualType ofType, size_t allocSize,
                            unsigned align = 0, bool heap = false,
                            bool IsLet = false, llvm::StringRef name = "");

   AllocBoxInst* CreateAllocBox(QualType Ty, Function* Deinitializer = nullptr,
                                llvm::StringRef name = "");

   DeallocInst* CreateDealloc(Value* V, bool Heap = false,
                              llvm::StringRef name = "");

   DeallocBoxInst* CreateDeallocBox(Value* V, llvm::StringRef name = "");

   Instruction* AllocUninitialized(size_t size, unsigned align = 0,
                                   bool heap = false,
                                   llvm::StringRef name = "");

   AssignInst* CreateAssign(Value* Src, Value* Dst,
                            MemoryOrder memoryOrder = MemoryOrder::NotAtomic,
                            llvm::StringRef name = "");

   StoreInst* CreateStore(Value* Src, Value* Dst,
                          MemoryOrder memoryOrder = MemoryOrder::NotAtomic,
                          llvm::StringRef name = "");

   InitInst* CreateInit(Value* Src, Value* Dst, llvm::StringRef name = "");

   MoveInst* CreateMove(Value* Target, llvm::StringRef Name = "");

   BeginBorrowInst* CreateBeginBorrow(Value* Target, SourceLocation BeginLoc,
                                      SourceLocation EndLoc, bool Mutable,
                                      llvm::StringRef Name = "");

   EndBorrowInst* CreateEndBorrow(Value* Target, SourceLocation Loc,
                                  bool Mutable, llvm::StringRef Name = "");

   FieldRefInst* CreateFieldRef(Value* val, const DeclarationName& fieldName,
                                bool IsLet = false, llvm::StringRef name = "");

   GEPInst* CreateStructGEP(Value* val, size_t idx, bool IsLet = false,
                            llvm::StringRef name = "");

   GEPInst* CreateGEP(Value* val, size_t idx, bool IsLet = false,
                      llvm::StringRef name = "");

   Instruction* CreateExtractValue(Value* val, size_t idx, bool IsLet = false,
                                   llvm::StringRef name = "");
   ...
   EnumRawValueInst* CreateEnumRawValue(Value* Val, bool LoadVal = true,
                                        llvm::StringRef name = "");

   EnumExtractInst* CreateEnumExtract(Value* Val, ast::EnumCaseDecl* Case,
                                      size_t caseVal, bool IsLet = false,
                                      llvm::StringRef name = "");
   ...
   EnumInitInst* CreateEnumInit(ast::EnumDecl* EnumTy, ast::EnumCaseDecl* Case,
                                llvm::ArrayRef<Value*> args,
                                llvm::StringRef name = "");

   LambdaInitInst* CreateLambdaInit(Function* Function, QualType LambdaTy,
                                    llvm::ArrayRef<Value*> Captures,
                                    llvm::StringRef name = "");

   UnionCastInst* CreateUnionCast(Value* target, ast::UnionDecl* UnionTy,
                                  const IdentifierInfo* fieldName,
                                  llvm::StringRef name = "");

   ExceptionCastInst* CreateExceptionCast(Value* Lpad, QualType toType,
                                          llvm::StringRef name = "");

   RetInst* CreateRet(Value* Val, StringRef name = "");
   RetInst* CreateRetVoid(llvm::StringRef name = "");

   YieldInst* CreateYield(Value* Val, BasicBlock* ResumeDst,
                          ArrayRef<Value*> ResumeArgs, bool FinalYield = false,
                          StringRef name = "");

   YieldInst* CreateYieldVoid(BasicBlock* ResumeDst,
                              ArrayRef<Value*> ResumeArgs,
                              bool FinalYield = false, StringRef name = "");

   ThrowInst* CreateThrow(Value* thrownVal, GlobalVariable* typeInfo,
                          llvm::StringRef name = "");

   RethrowInst* CreateRethrow(Value* thrownVal, llvm::StringRef name = "");

   UnreachableInst* CreateUnreachable(llvm::StringRef name = "");

   BrInst* CreateBr(BasicBlock* target, llvm::ArrayRef<Value*> BlockArgs = {},
                    llvm::StringRef name = "");

   BrInst* CreateUnresolvedBr(llvm::StringRef name = "");

   BrInst* CreateCondBr(Value* Condition, BasicBlock* IfBranch,
                        BasicBlock* ElseBranch,
                        llvm::ArrayRef<Value*> TargetArgs = {},
                        llvm::ArrayRef<Value*> ElseArgs = {},
                        llvm::StringRef name = "");

   SwitchInst* CreateSwitch(Value* SwitchVal, BasicBlock* DefaultDst = nullptr,
                            llvm::StringRef name = "");

   LandingPadInst* CreateLandingPad(llvm::StringRef name = "");

   BinaryOperatorInst* CreateBinOp(unsigned char OpCode, Value* lhs, Value* rhs,
                                   llvm::StringRef name = "",
                                   SourceLocation loc = {});

   UnaryOperatorInst* CreateUnaryOp(unsigned char OpCode, Value* target,
                                    llvm::StringRef name = "",
                                    SourceLocation loc = {});

   CompInst* CreateComp(unsigned char OpCode, Value* lhs, Value* rhs,
                        llvm::StringRef name = "", SourceLocation loc = {});
...
#define CDOT_COMP_OP(Name, OP)                                                 \
   CompInst* Create##Name(Value* lhs, Value* rhs, llvm::StringRef name = "",   \
                          SourceLocation loc = {});

#define CDOT_UNARY_OP(Name, OP)                                                \
   UnaryOperatorInst* Create##Name(Value* target, llvm::StringRef name = "");
...
#define CDOT_INT_CAST(Kind)                                                    \
   IntegerCastInst* Create##Kind(Value* val, QualType toType,                  \
                                 llvm::StringRef name = "")                    \
   {                                                                           \
...
#define CDOT_FP_CAST(Kind)                                                     \
   FPCastInst* Create##Kind(Value* val, QualType toType,                       \
                            llvm::StringRef name = "")                         \
   {                                                                           \
...
#undef CDOT_FP_CAST
   ...
   FPCastInst* CreateFPCast(CastKind kind, Value* val, QualType toType,
                            llvm::StringRef name = "");

   BitCastInst* CreateBitCast(CastKind kind, Value* val, QualType toType,
                              llvm::StringRef name = "");

   DynamicCastInst* CreateDynamicCast(il::Value* val, il::Value* TargetTypeInfo,
   ...
   ExistentialInitInst*
   CreateExistentialInit(Value* target, QualType toType,
                         il::Value* ValueTypeInfo,
                         il::GlobalVariable* ProtocolTypeInfo,
                         bool Preallocated = false, StringRef name = "");
   ...
   struct SynthesizedRAII {
      ...
      ~SynthesizedRAII() { Builder.SyntesizedContext = Prev; }
...
protected:
   ...
   void insertInstruction(Instruction* inst, llvm::StringRef name = "");
