...
private:
   ...
   NestedNameSpecifier(IdentifierInfo* Ident, NestedNameSpecifier* Previous);

   /// \brief get or create a uniqued name specifier.
   NestedNameSpecifier(ast::NamespaceDecl* NS, NestedNameSpecifier* Previous);

   /// \brief get or create a uniqued name specifier.
   NestedNameSpecifier(QualType Type, NestedNameSpecifier* Previous);
   ...
   /// \brief get or create a uniqued name specifier.
   NestedNameSpecifier(ast::AliasDecl* Alias, NestedNameSpecifier* Previous);

   /// \brief get or create a uniqued name specifier.
   NestedNameSpecifier(cdot::Module* M, NestedNameSpecifier* Previous);
...
public:
   ...
   /// \brief get or create a uniqued name specifier.
   static NestedNameSpecifier* Create(DeclarationNameTable& Tbl, QualType Type,
                                      NestedNameSpecifier* Previous = nullptr);
   ...
   Create(DeclarationNameTable& Tbl,
