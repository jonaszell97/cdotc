//
// Copied from https://github.com/apple/swift/blob/
// a7ff0da33488b9050cf83df95f46e5b9aa2348d5/include/swift/Basic/DiverseStack.h
//

#ifndef CDOT_DIVERSESTACK_H
#define CDOT_DIVERSESTACK_H
...
public:
   ...
   public:
      ...
      bool isValid() const { return Depth != (std::size_t)-1; }
   ...
   stable_iterator stable_begin() const { return stable_iterator(End - Begin); }
...
protected:
   DiverseStackImpl(char* end) { initialize(end); }
...
public:
   ...
   /// Pop objects off of the stack until \p the object pointed to by
   /// stable_iter is the top element of the stack.
...
struct PointerLikeTypeTraits<
    cdot::DiverseStackBase::stable_iterator::AsPointer> {
   using AsPointer = cdot::DiverseStackBase::stable_iterator::AsPointer;
