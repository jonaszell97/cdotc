...
//         || (to->isObjectTy() && to->getClassName() == "Char" && from->isIntegerTy())
//         || (to->isObjectTy() && to->getClassName() == "Bool" && from->isIntegerTy()))
//      {
...
//         || (from->isObjectTy() && from->getClassName() == "Char" && to->isIntegerTy())
//         || (from->isObjectTy() && from->getClassName() == "Bool" && to->isIntegerTy()))
//      {
...
//         QualType from(fromTuple->getContainedType(i));
//         QualType to(toTuple->getContainedType(i));
//
...
//
//      assert(
//         from->isObjectTy() && to->isObjectTy() && "Incompatible types for cast");
