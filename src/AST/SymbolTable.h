...
public:
    static cdot::cl::Class* declareClass(string class_name, ObjectType *extends, std::vector<ObjectType *>
        implements, std::vector<GenericType *> generics, ClassDecl *decl, bool is_abstract);
    static cdot::cl::Class* declareClass(string,std::vector<ObjectType *>, std::vector<GenericType *>, bool, ClassDecl *);
