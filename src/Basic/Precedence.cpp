...
#define CDOT_OPERATOR(Name, Symbol, PG, Fix) .Case(Symbol, Name)
#include "cdotc/Basic/BuiltinOperators.def"
       .Default(UnknownOp);
}
...
OperatorKind fromToken(lex::tok::TokenType kind)
{
   ...
   case tok::ashr_equals:
      return op::AShrAssign;
   case tok::lshr_equals:
      return op::LShrAssign;
   case tok::and_equals:
      return op::AndAssign;
   case tok::or_equals:
      return op::OrAssign;
...
#define CDOT_OPERATOR(Name, Symbol, PG, Fix) Symbol,
#include "cdotc/Basic/BuiltinOperators.def"
};
