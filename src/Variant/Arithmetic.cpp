...
//        if (v1._type.type == STRING_T) {
//            return v1.s_val + v2.to_string();
//        }
//        if (v2._type.type == STRING_T) {
//            return v1.to_string() + v2.s_val;
//        }
//        if (v1._type.type == CHAR_T) {
//            return v1.c_val + v2.to_string();
//        }
//        if (v2._type.type == CHAR_T) {
//            return v1.to_string() + v2.c_val;
//        }
//
//        switch (v1._type.type) {
//            case INT_T:
//                switch (v2._type.type) {
//                    case INT_T:
...
//        }
//
//        RuntimeError::raise(ERR_BAD_CAST, "Cannot add values of type " + val::typetostr(v1._type.type)
//                                          + " and " + val::typetostr(v2._type.type));
//    }
//
...
//        }
//
//        RuntimeError::raise(ERR_BAD_CAST, "Cannot apply modulo to values of type " + val::typetostr(v1._type.type)
//                                          + " and " + val::typetostr(v2._type.type));
//    }
//
...
//        }
//
//        RuntimeError::raise(ERR_BAD_CAST, "Cannot negate value of type " + val::typetostr(v1._type.type));
//    }
//
...
//                val::typetostr(v1._type.type));
//    }
//
//    // equality ops
//
//    Variant Arithmetic::equal(Variant v1, Variant v2) {
//        if (v1._type.type == DOUBLE_T && v1.d_val < INT32_MAX) {
//            v1._type.type = INT_T;
//            v1.int_val = int(v1.d_val);
//        }
//        if (v2._type.type == DOUBLE_T && v2.d_val < INT32_MAX) {
//            v2._type.type = INT_T;
...
//            return true;
//        }
//        if (v1._type.type != v2._type.type) {
//            return false;
//        }
//
//        switch (v1._type.type) {
...
//        }
//
//        RuntimeError::raise(ERR_BAD_CAST, "Cannot compare values of type " + val::typetostr(v1._type.type)
//                                          + " and " + val::typetostr(v2._type.type));
//    }
//
...
//            + val::typetostr(v1._type.type) + " and " + val::typetostr(v2._type.type));
//    }
//
...
//        if (v1._type.type == BOOL_T && v2._type.type == BOOL_T) {
//            return { v1.b_val && v2.b_val };
//        }
//
//        RuntimeError::raise(ERR_BAD_CAST, "Cannot apply logical and to values of type " + val::typetostr(v1._type.type)
//                                          + " and " + val::typetostr(v2._type.type));
//    }
//
...
//        }
//
//        RuntimeError::raise(ERR_BAD_CAST, "Cannot apply logical or to values of type " + val::typetostr(v1._type.type)
//                                          + " and " + val::typetostr(v2._type.type));
//    }
//
//    // bitwise operators
...
//        }
//
//        RuntimeError::raise(ERR_BAD_CAST, "Cannot apply bitwise and to values of type " + val::typetostr(v1._type.type)
//                                          + " and " + val::typetostr(v2._type.type));
//    }
//
...
//        }
//
//        RuntimeError::raise(ERR_BAD_CAST, "Cannot apply bitwise or to values of type " + val::typetostr(v1._type.type)
//                                          + " and " + val::typetostr(v2._type.type));
//    }
//
...
//        }
//
//        RuntimeError::raise(ERR_BAD_CAST, "Cannot apply left bitshift to values of type " + val::typetostr(v1._type.type)
//                                          + " and " + val::typetostr(v2._type.type));
//    }
//
...
//        }
//
//        RuntimeError::raise(ERR_BAD_CAST, "Cannot apply right bitshift to values of type " + val::typetostr(v1._type.type)
//                                          + " and " + val::typetostr(v2._type.type));
//    }
//
//} // namespace var
