...
template<class T>
struct IsLowBitAvailable {
   static constexpr bool value = false;
};

template<class T, bool = IsLowBitAvailable<T>::value>
class ActionResult {
   T Val;
   bool Valid;

public:
   ActionResult(T Val, bool Valid)
      : Val(Val), Valid(Valid)
   {}
