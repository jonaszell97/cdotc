...
BasicBlock* ILBuilder::getInsertBlock() { return InsertBlock; }
...
void ILBuilder::insertInstruction(Instruction* inst, llvm::StringRef name)
{
...
BasicBlock* ILBuilder::CreateBasicBlock(Function* func, bool setInsertPoint,
                                        llvm::StringRef name)
{
...
ConstantInt* ILBuilder::GetConstantInt(QualType ty, const llvm::APSInt& Val)
{
...
ConstantInt* ILBuilder::GetTrue() { return ConstantInt::getTrue(Ctx); }

ConstantInt* ILBuilder::GetFalse() { return ConstantInt::getFalse(Ctx); }
...
ConstantFloat* ILBuilder::GetConstantFP(QualType ty, const llvm::APFloat& Val)
{
...
ConstantClass* ILBuilder::ReplaceForwardDecl(ConstantClass* ForwardDecl,
                                             ...
                                             ConstantClass* Base)
{
   return ReplaceForwardDecl(
       ForwardDecl, ConstantStruct::get(ForwardDecl->getType(), elements),
       Base);
}
...
ConstantArray* ILBuilder::GetConstantArray(QualType ty, size_t numElements)
{
   return ConstantArray::get(
       ValueType(Ctx, ASTCtx.getArrayType(ty, numElements)), {});
}
...
MagicConstant* ILBuilder::GetMagicConstant(unsigned char Kind)
{
   ...
   return MagicConstant::get(
       ValueType(Ctx, getMagicConstantType(ASTCtx, RealKind)), RealKind);
}

Constant* ILBuilder::GetTokenNone() { return il::ConstantTokenNone::get(Ctx); }
...
Argument* ILBuilder::CreateArgument(QualType type,
                                    ...
                                    BasicBlock* parent, llvm::StringRef name,
                                    SourceLocation loc)
{
...
Function* ILBuilder::CreateFunction(Value::TypeID Kind, llvm::StringRef name,
                                    ...
                                    bool OverridePrevious)
{
   ...
   case Value::FunctionID:
      ...
      break;
   case Value::MethodID:
      Fn = new Method(name, support::cast<FunctionType>(*functionType), false,
                      false, false, M);
      break;
...
Method* ILBuilder::CreateMethod(llvm::StringRef methodName, QualType returnType,
                                llvm::ArrayRef<Argument*> args, bool isStatic,
                                bool isVirtual, bool mightThrow, bool vararg,
                                bool isDeinit, SourceLocation loc)
{
   llvm::SmallVector<QualType, 8> argTypes;
   for (auto& arg : args)
      argTypes.push_back(arg->getType());
   ...
   auto M
       = new Method(methodName, FuncTy, isStatic, isVirtual, isDeinit, this->M);
                                          ...
                                          SourceLocation loc)
{
   ...
   auto FuncTy = ASTCtx.getFunctionType(ASTCtx.getVoidType(), argTypes, flags);
...
CallInst* ILBuilder::CreateCall(Value* Callee, llvm::ArrayRef<Value*> args,
                                llvm::StringRef name)
{
...
void checkIntrinsicArgs(Intrinsic id, llvm::ArrayRef<Value*> args)
{
   ...
   case Intrinsic::generic_argument_ref: {
      assert(args.size() == 3 && isPointerLike(args[0])
...
QualType getIntrinsicReturnType(ast::ASTContext& Ctx,
                                llvm::ArrayRef<Value*> args, Intrinsic id)
{
#ifndef NDEBUG
   ...
   case Intrinsic::indirect_case_ref:
      return Ctx.getMutableReferenceType(Ctx.getInt8PtrTy());
   case Intrinsic::unbox:
      return Ctx.getMutableReferenceType(
          args.front()->getType()->getBoxedType());
   case Intrinsic::typeinfo_cmp:
                                                  ...
                                                  llvm::StringRef name)
{
   auto inst = new IntrinsicCallInst(
       id, ValueType(Ctx, getIntrinsicReturnType(ASTCtx, args, id)), args,
       getInsertBlock());
...
ILBuilder::CreateLLVMIntrinsicCall(IdentifierInfo* intrinsic,
                                   QualType returnType,
                                   ArrayRef<il::Value*> args, StringRef name)
{
   auto inst = new LLVMIntrinsicCallInst(intrinsic, ValueType(Ctx, returnType),
                                         args, getInsertBlock());
...
Instruction* ILBuilder::GetStrongRefcount(il::Value* V, llvm::StringRef name)
{
   return CreateIntrinsicCall(Intrinsic::strong_refcount, V, name);
}

Instruction* ILBuilder::GetWeakRefcount(il::Value* V, llvm::StringRef name)
{
   return CreateIntrinsicCall(Intrinsic::weak_refcount, V, name);
}

Instruction* ILBuilder::GetVTable(il::Value* V, llvm::StringRef name)
{
   return CreateIntrinsicCall(Intrinsic::vtable_ref, V, name);
}

Instruction* ILBuilder::GetTypeInfo(il::Value* V, llvm::StringRef name)
{
   return CreateIntrinsicCall(Intrinsic::typeinfo_ref, V, name);
}

Instruction* ILBuilder::CreateRetain(il::Value* V, llvm::StringRef name)
{
...
Instruction* ILBuilder::CreateRelease(il::Value* V, llvm::StringRef name)
{
...
Instruction* ILBuilder::CreateWeakRetain(il::Value* V, llvm::StringRef name)
{
...
Instruction* ILBuilder::CreateWeakRelease(il::Value* V, llvm::StringRef name)
{
...
Instruction* ILBuilder::CreateLifetimeBegin(il::Value* V, llvm::StringRef name)
{
   return CreateIntrinsicCall(Intrinsic::lifetime_begin, V, name);
}

Instruction* ILBuilder::CreateLifetimeEnd(il::Value* V, llvm::StringRef name)
{
   return CreateIntrinsicCall(Intrinsic::lifetime_end, V, name);
}

VirtualCallInst*
ILBuilder::CreateVirtualCall(Value* VTableOwner, FunctionType* FnTy,
                             il::GlobalVariable* ProtocolTypeInfo,
                             unsigned Offset, ArrayRef<Value*> args,
                             StringRef name)
{
   auto inst = new VirtualCallInst(
       VTableOwner, FnTy->getCanonicalType()->asFunctionType(),
       ProtocolTypeInfo, Offset, args, getInsertBlock());
...
{
   auto inst
       = new InvokeInst(Callee, args, NormalCont, LandingPad, getInsertBlock());
   insertInstruction(inst, name);
...
VirtualInvokeInst*
ILBuilder::CreateVirtualInvoke(Value* VTableOwner, FunctionType* FnTy,
                               il::GlobalVariable* ProtocolTypeInfo,
                               unsigned Offset, ArrayRef<Value*> args,
                               BasicBlock* NormalCont, BasicBlock* LandingPad,
                               StringRef name)
{
   auto inst = new VirtualInvokeInst(VTableOwner,
                                     FnTy->getCanonicalType()->asFunctionType(),
                                     ProtocolTypeInfo, Offset, args, NormalCont,
                                     LandingPad, getInsertBlock());

   insertInstruction(inst, name);
   return inst;
}

AllocaInst* ILBuilder::CreateAlloca(QualType ofType, unsigned int align,
                                    bool heap, bool IsLet, llvm::StringRef name)
{
   auto inst = new AllocaInst(ValueType(Ctx, ofType), IsLet, getInsertBlock(),
                              align, heap);
...
AllocaInst* ILBuilder::CreateAlloca(QualType ofType, Value* allocSize,
                                    unsigned int align, bool heap, bool IsLet,
                                    llvm::StringRef name)
{
   auto inst = new AllocaInst(ValueType(Ctx, ofType), IsLet, getInsertBlock(),
                              allocSize, align, heap);

   insertInstruction(inst, name);
   return inst;
}

AllocaInst* ILBuilder::CreateAlloca(QualType ofType, size_t allocSize,
                                    unsigned int align, bool heap, bool IsLet,
                                    llvm::StringRef name)
{
...
Instruction* ILBuilder::AllocUninitialized(size_t size, unsigned int align,
                                           bool heap, llvm::StringRef name)
{
...
AllocBoxInst* ILBuilder::CreateAllocBox(QualType Ty, Function* Deinitializer,
                                        llvm::StringRef name)
{
...
DeallocInst* ILBuilder::CreateDealloc(il::Value* V, bool Heap,
                                      llvm::StringRef name)
{
...
DeallocBoxInst* ILBuilder::CreateDeallocBox(il::Value* V, llvm::StringRef name)
{
...
AssignInst* ILBuilder::CreateAssign(Value* val, Value* ptr,
...
StoreInst* ILBuilder::CreateStore(Value* val, Value* ptr,
                                  MemoryOrder memoryOrder, llvm::StringRef name)
{
...
InitInst* ILBuilder::CreateInit(Value* val, Value* ptr, llvm::StringRef name)
{
...
BeginBorrowInst* ILBuilder::CreateBeginBorrow(il::Value* Target,
                                              ...
                                              llvm::StringRef Name)
{
   auto Inst = new BeginBorrowInst(Target, BeginLoc, EndLoc, Mutable,
                                   getInsertBlock());
...
EndBorrowInst* ILBuilder::CreateEndBorrow(il::Value* Target, SourceLocation Loc,
                                          bool Mutable, llvm::StringRef Name)
{
...
GEPInst* ILBuilder::CreateStructGEP(il::Value* val, size_t idx, bool IsLet,
                                    llvm::StringRef name)
{
...
GEPInst* ILBuilder::CreateGEP(Value* val, size_t idx, bool IsLet,
                              llvm::StringRef name)
{
...
Instruction* ILBuilder::CreateExtractValue(Value* val, size_t idx, bool IsLet,
                                           llvm::StringRef name)
{
   return CreateLoad(CreateGEP(val, idx, IsLet, name));
}

GEPInst* ILBuilder::CreateGEP(Value* val, Value* idx, bool IsLet,
                              llvm::StringRef name)
{
...
EnumRawValueInst* ILBuilder::CreateEnumRawValue(Value* Val, bool LoadVal,
                                                llvm::StringRef name)
{
...
LoadInst* ILBuilder::CreateLoad(Value* val, MemoryOrder memoryOrder,
                                llvm::StringRef name)
{
...
Instruction* ILBuilder::CreateAddrOf(Value* target, llvm::StringRef name)
{
...
StructInitInst* ILBuilder::CreateStructInit(ast::StructDecl* InitializedType,
                                            Method* Init,
                                            llvm::ArrayRef<Value*> args,
                                            bool Fallible, QualType FallibleTy,
                                            llvm::StringRef name)
{
...
{
   auto inst
       = new LambdaInitInst(Function, LambdaTy, Captures, getInsertBlock());
   insertInstruction(inst, name);
...
ExceptionCastInst* ILBuilder::CreateExceptionCast(Value* val, QualType toType,
                                                  llvm::StringRef name)
{
...
YieldInst* ILBuilder::CreateYield(il::Value* Val, BasicBlock* ResumeDst,
                                  ArrayRef<Value*> ResumeArgs, bool FinalYield,
                                  StringRef name)
{
   auto inst = new YieldInst(Val, ResumeDst, ResumeArgs, FinalYield,
                             getInsertBlock());
...
YieldInst* ILBuilder::CreateYieldVoid(BasicBlock* ResumeDst,
                                      ...
                                      bool FinalYield, StringRef name)
{
   auto inst = new YieldInst(Ctx, ResumeDst, ResumeArgs, FinalYield,
                             getInsertBlock());
...
BrInst* ILBuilder::CreateCondBr(Value* Condition, BasicBlock* IfBranch,
                                BasicBlock* ElseBranch,
                                llvm::ArrayRef<Value*> TargetArgs,
                                llvm::ArrayRef<Value*> ElseArgs,
                                llvm::StringRef name)
{
   auto inst = new BrInst(Condition, IfBranch, TargetArgs, ElseBranch, ElseArgs,
                          getInsertBlock());
   insertInstruction(inst, name);
...
SwitchInst* ILBuilder::CreateSwitch(Value* SwitchVal, BasicBlock* DefaultDst,
                                    llvm::StringRef name)
{
...
BinaryOperatorInst* ILBuilder::CreateBinOp(unsigned char OpCode, il::Value* lhs,
                                           il::Value* rhs, llvm::StringRef name,
                                           SourceLocation loc)
{
   auto inst = new BinaryOperatorInst((BinaryOperatorInst::OpCode)OpCode, lhs,
                                      rhs, getInsertBlock());
...
UnaryOperatorInst* ILBuilder::CreateUnaryOp(unsigned char OpCode,
                                            ...
                                            SourceLocation loc)
{
   auto inst = new UnaryOperatorInst((UnaryOperatorInst::OpCode)OpCode, target,
                                     getInsertBlock());
...
CompInst* ILBuilder::CreateComp(unsigned char OpCode, il::Value* lhs,
                                il::Value* rhs, llvm::StringRef name,
                                SourceLocation loc)
{
   auto inst
       = new CompInst((CompInst::OpCode)OpCode, lhs, rhs, getInsertBlock());
...
#define CDOT_BINARY_OP(Name, OP)                                               \
   BinaryOperatorInst* ILBuilder::Create##Name(                                \
       Value* lhs, Value* rhs, llvm::StringRef name, SourceLocation loc)       \
   {                                                                           \
      auto inst = new BinaryOperatorInst(BinaryOperatorInst::Name, lhs, rhs,   \
                                         getInsertBlock());                    \
      insertInstruction(inst, name);                                           \
      return inst;                                                             \
   }
...
#define CDOT_COMP_OP(Name, OP)                                                 \
   ...
   {                                                                           \
      auto inst = new CompInst(CompInst::Name, lhs, rhs, getInsertBlock());    \
      insertInstruction(inst, name);                                           \
      return inst;                                                             \
   }
...
FPCastInst* ILBuilder::CreateFPCast(CastKind kind, Value* val, QualType toType,
                                    llvm::StringRef name)
{
...
ExistentialCastInst* ILBuilder::CreateExistentialCast(il::Value* Target,
                                                      ...
                                                      StringRef name)
{
   auto inst = new ExistentialCastInst(Target, TargetTypeInfo, Kind, TargetType,
                                       getInsertBlock());
...
ExistentialInitInst* ILBuilder::CreateExistentialInit(
    il::Value* target, QualType toType, il::Value* ValueTypeInfo,
    il::GlobalVariable* ProtocolTypeInfo, bool Preallocated, StringRef name)
{
...
Value* ILBuilder::CreateIsZero(Value* V) { return CreateIsX(V, 0); }

Value* ILBuilder::CreateIsOne(Value* V) { return CreateIsX(V, 1); }
