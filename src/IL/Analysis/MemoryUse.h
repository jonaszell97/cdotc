...
inline MemoryRestriction::RestrictionKind operator |(
                                       MemoryRestriction::RestrictionKind LHS,
...
struct MemoryUse {
   enum Kind : unsigned char {
      ImmutableBorrow, MutableBorrow, Move,
   };
...
public:
   MemoryUse(Kind UseKind,
             ...
             MemoryLocation AccessedMem,
             llvm::ArrayRef<MemoryRestriction> Restrictions = {})
      : UseKind(UseKind), Loc(Loc),
        AccessedMem(AccessedMem), Restrictions(Restrictions)
   {}
