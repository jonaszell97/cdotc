...
#include "IL/Analysis/MemoryLocation.h"
#include "Passes.h"
...
class BorrowCheckPass: public FunctionPass,
                       public InstructionVisitor<BorrowCheckPass, void,
                                                 llvm::BitVector&,
                                                 llvm::BitVector&> {
   /// The ILGen object
   ast::ILGenPass &ILGen;
   ...
   void buildRestrictions(il::Value *V,
   ...
   void checkConflictingRestriction(const Instruction &I,
                                    MemoryLocation Loc,
                                    const MemoryUse &Use,
                                    const MemoryRestriction &Restriction);

   void checkConflictingUse(const Instruction &I,
                            MemoryLocation Loc,
                            const MemoryUse &Use,
...
public:
   explicit BorrowCheckPass(ast::ILGenPass &ILGen)
      : FunctionPass(PassKind::BorrowCheckPassID),
      ILGen(ILGen), Allocator()
   {}
